...
O **ODA·ADS** é uma plataforma educacional single-page construída em HTML/CSS/JS puro, sem frameworks ou dependências de build. Reúne conteúdo teórico, exercícios gamificados e recursos de revisão para os principais temas do curso de Análise e Desenvolvimento de Sistemas.
...
| **Quiz com 34 questões** | Timer por questão, feedback imediato, atalhos de teclado (1–4 / Enter) |
...
| **Certificado digital** | Gerado com nome, pontuação, data e código único (salvo em localStorage) |
...
- Persistencia: `localStorage` (certificado, progresso)
